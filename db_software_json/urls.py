...
urlpatterns = [
    ...
    path('mysoftware/<int:pk>/', MySoftwareView.as_view()),
    path('softrequest_list/', SoftRequestListView.as_view(), name='softrequest_list'),
    path('borrowsoftware_list/', BorrowSoftwareListView.as_view(), name='borrowsoftware_list'),
]
